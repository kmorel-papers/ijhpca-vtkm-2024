...
\begin{abstract}
  ...
  Exascale machines use GPUs as accelerator processors to provide the highest computational throughput available today, necessitating an algorithmic design that often deviates from a classical computer.
%
