...
\newcommand*{\authorcomment}[3][Crimson]{\textcolor{#1}{\textbf{\emph{#3}} (#2)}}
...
\runninghead{Moreland, Bolea, Bolstad, Childs, Lo, Geveci, Marsaglia, Philip, Pugmire, Rizzi, and Yenpure}
...
\affiliation{%
  ...
  \affilnum{6}Lawrence Livermore National Laboratory, USA\\
  \affilnum{7}Argonne National Laboratory, USA
}
...
\begin{abstract}
  ...
  \ken{\url{https://drive.google.com/drive/folders/19xAWuQSQQb9uRAfHlGfhI1N4bcXYiRNk} $\leftarrow$ information about the IJHPCA special issue}
\end{abstract}
