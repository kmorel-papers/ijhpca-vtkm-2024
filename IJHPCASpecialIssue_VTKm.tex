...
\begin{abstract}
  ...
  VTK-m is a software library that enables scientific visualization on Exascale machines.
  ...
  Finally, we show how VTK-m helps scientific discovery for applications like fusion and particle acceleration that leverage an Exascale supercomputer.
