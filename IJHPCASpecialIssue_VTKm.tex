...
\begin{abstract}
  ...
  We document the surprises and obstacles faced when moving from pre-exascale platforms to the final exascale designs and the performance on those systems.
...
\keywords{visualization, exascale, VTK-m, parallel, ECP, GPU, Frontier, Auroria, in situ}
