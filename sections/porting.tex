...
The ability to control template instantation and seperate, concurrent compilation of the filter library has greatly reduce library and application built time. \ollie{Ken can you add some concrete timing measure as you did before here?}
